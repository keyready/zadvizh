        ...
        <section className="bg-main-gradient relative flex h-screen w-full flex-col items-start justify-start overflow-y-auto px-3 py-20 lg:px-[15vw]">
            <div className="flex flex-col gap-3">
                <h1 className="text-xl font-bold lg:text-3xl">
                    Рейтинг профессорско-преподавательского состава
                </h1>
                ...
                <p className="text-md italic opacity-40 lg:text-2xl">
                    <b>ВАЖНО</b>: мы не храним в открытом виде информацию о том, кто какие оценки
                    поставил. ID пользователей хранятся в зашифрованном в одностороннем порядке виде
                    и нужны только для того, чтобы оценки не дублировались
                </p>
            </div>
